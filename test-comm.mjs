// Simple email & SMS test script using ES modules
import { checkEmailServiceStatus, sendEmail } from './server/services/email-service.js';
import { checkSmsServiceStatus, sendSms } from './server/services/sms-service.js';
