...
export function GoogleLogin({ 
  ...
  return (
    <Button
      ...
      className={`bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 ${className}`}
...
// Component for disconnecting Google
export function GoogleDisconnect({ className = '' }: { className?: string }) {
